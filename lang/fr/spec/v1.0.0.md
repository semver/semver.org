...
élément DOIT s'incrémenter numériquement par incréments de un. Par exemple : 
1.9.0 -> 1.10.0 -> 1.11.0.
...
ASCII ascendant. Par exemple : 1.0.0-alpha1 < 1.0.0-beta1 < 1.0.0-beta2 < 1.0.0-rc1 < 1.0.0.
...
peut être important. Le besoin de faire évoluer la version majeure pour livrer des 
...
telles circonstances, il est inacceptable de modifier une version déjà livrée. 
