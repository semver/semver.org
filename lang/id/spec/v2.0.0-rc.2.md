---
title: Pemversian Semantik 2.0.0-rc-2
language: id
---
...
Kata/frasa "HARUS" ("MUST"), "TIDAK BOLEH" ("MUST NOT"), "DIBUTUHKAN" ("REQUIRED"), "SEHARUSNYA" ("SHALL"), "JANGAN SAMPAI" ("SHALL NOT"), "SEBAIKNYA" ("SHOULD"), "SEBAIKNYA TIDAK" ("SHOULD NOT"), "DIREKOMENDASIKAN" ("RECOMMENDED"), "BISA" ("MAY")  di dokumen ini sesuai dengan [RFC 2119](http://tools.ietf.org/html/rfc2119).
...
1. Presedens HARUS dihitung dengan memisahkan versi menjadi pengenal *major*, *minor*, *patch*, dan prarilis dalam urutan tersebut (*Build metadata* tidak diperhitungkan dalam pengurutan). Presedens prarilis HARUS ditentukan dengan membandingkan setiap pengenal yang dipisahkan titik sebagai berikut: pengenal yang hanya terdiri dari angka dibandingkan secara numerik dan pengenal dengan huruf atau tanda hubung dibandingkan secara leksikal dalam urutan pengurutan ASCII. Pengenal numerik selalu memiliki prioritas yang lebih rendah daripada pengenal non-numerik. Contoh: 1.0.0-alpha < 1.0.0-alpha.1 < 1.0.0-beta.2 < 1.0.0-beta.11 < 1.0.0-rc.1 < 1.0.0.
