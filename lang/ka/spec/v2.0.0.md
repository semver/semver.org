...
«დამოკიდებულებების ჯოჯოხეთი» (dependency hell). რაც უფრო იზრდება სისტემა და 
რაც უფრო მეტი ბიბლიოთეკის ინტეგრირება ხდება პროექტში, მით უფრო იზრდება 
ალბათობა ამ სიტუაციაში მოხვედრისა.

სისტემაში სადაც ბევრი დამოკიდებულებებია, ახალი ვერსიის გამოშვება შეიძლება 
...
«დამოკიდებულებების ჯოჯოხეთი» არის მდგომარეობა როდესაც დამოკიდებულებების არსებობა 
...
იმისათვის რომ ამ სისტემამ იმუშაოს, თქვენ უნდა განსაზღვროთ ღია (public) API.
ის შეიძლება აღიწეროს როგორც დოკუმენტაციაში, ასევე თავად კოდის მეშვეობით. მთავარია, 
რომ ეს API იყოს გასაგები და ზუსტი. მას შემდეგ რაც ერთხელ აღწერთ ღია API-ს, 
...
«შეიძლება» (MAY) и «სურვილისამებრ» (OPTIONAL) ამ დოკუმენტში უნდა იქნეს 
ინტერპრეტირებული შესაბამისად [RFC 2119](http://tools.ietf.org/html/rfc2119).

1. პროგრამული უზრუნველყოფა რომელიც იყენებს სემანტიკურ ვერსიონირებას, 
«უნდა» აღწერდეს ღია API-ს. ეს API შეიძლება იყოს აღწერილი თვითონ კოდში 
...
ყველაფერი შეიძლება შეიცვალოს ნებისმიერ მომენტში. ღია API არ შეიძლება 
განიხილოს როგორც სტაბილური.

1. ვერსია 1.0.0 განსაზღვრავს ღია API-ს. ამ რელიზის შემდეგ ვერსიის ნომრები იზრდება
იმის მიხედვით თუ როგორ იცვლება ღია API.
...
თუ ღია API-ში წარმოდგენილია ახალი უკუთავსებადი ფუნქციონალი. «უნდა» გაიზარდოს 
იმ შემთხვევაში, თუ ღია API-ს რომელიმე ფუნქციონალი მოინიშნა როგორც მოძველებული 
...
თუ ღია API-ში წარმოდგენილია რაიმე არა უკუთავსებადი ცვლილებები.
...
ვიდრე ნაკლებ რაოდენობას. მაგალითი: 1.0.0-alpha < 1.0.0-alpha.1 < 1.0.0-alpha.beta < 1.0.0-beta < 
...
«დამოკიდებულებების ჯოჯოხეთი» აქციოს წარსულად. წარმოვიდგინოთ ბიბლიოთეკა სახელად 
...
ვერსიონირებას მიცეთ საშუალება დაგეხმაროთ რელიზების გამოშვებაში, მასზე დამოკიდებული 
...
დაამატეთ ამ საიტის ბმული თქვენ README ფაილში, რათა მომხმარებლებმს იცოდნენ წესები 
...
მომხმარებლები, მაშინ ვერსია უნდა იყოს 1.0.0. თუ თქვენ შიშობთ უკუთავსებადობაზე, მაშინ დიდი 
...
მაჟორული ვერსიისთვის.

### ღია API-ში ძალიან უმნიშვნელო არა უკუთავსებადი ცვლილებებიც საჭიროებს ახალი მაჟორული ვერსიის გამოშვებას? ეს ხომ არ გამოიწვევს იმას, რომ ძალიან მალე ვერსიის ნომერი გახდება 42.0.0?
...
შეუძლია უსაფრთხოდ. ხანგრძლივ პერსპექტივაში სემანტიკური ვერსიონირება და ღია API-ს ხარისხიანი 
...
### რა უნდა გავაკეთო, თუ ვანახლებ საკუთარ დამოკიდებულებებს ღია API-ს ცვლილების გარეშე?

ეს შეიძლება განიხილოს როგორც თავსებადი ცვლილებები, რაკი მას გავლენა არ აქვს ღია API-ზე.
პროგრამულ უზრუნველყოფას რომელიც თავისმხრივ დამოკიდებულია იმავე დამოკიდებულებებზე, 
უნდა გააჩნდეს საკუთარი დამოკიდებულებების სპეციფიკაციები და ავტორი შეიტყობს შესაძლო 
კონფლიქტების შესახებ. ეს ცვლილებები უნდა აღიწეროს როგორც პატჩ-ვერსია თუ მინორული, 
...
### რა უნდა გავაკეთო, თუ შემთხვევით შევცვალე ღია API და არასწორად შევცვალე ვერსიის ნომერი (მაგალითად კოდი შეიცავს არა უკუთავსებად ცვლილებებს პატჩ-ვერსიაში)?
...
და ხშირად აუცილებელიც კია პროდუქტის განსავითარებლად. როდესაც ღია API-ს რაიმე ნაწილს 
...
არა, თუმცა იხელმძღვანელეთ საღი აზრით. ალბათ დამეთანხმებით 255 სიმბოლო ვერსიის ხაზში ზედმეტია.
