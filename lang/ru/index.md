...
целые числа и НЕ ДОЛЖНЫ содержать ведущие нули. X — мажорная версия, Y — минорная
...
НЕ ДОЛЖНЫ содержать ведущие нули. Предрелизные версии имеют более низкий приоритет,
