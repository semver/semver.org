...
У світі управління програмним забезпеченням існує таке поняття, як "dependency hell",
і з розростанням системи, та інтеграції в неї великої кількості пакетів дуже ймовірно
опинитись у цій ситуації.
