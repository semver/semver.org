...
1. Build metadata MAY be denoted by appending a plus sign and a series of dot
   ...
   two packages with the same version, but different build metadata are
   considered to be the same version. Examples: 1.0.0-alpha+001,
...
1. Precedence MUST be calculated by separating the version into major, minor,
   ...
   figure into precedence). Major, minor, and patch versions are always compared
   ...
   precedence than non-numeric identifiers. Example: 1.0.0-alpha < 1.0.0-alpha.1
